...
export const quoteActors: QuoteActor[] = [
  { id: 'demo-sales', name: '業務（模擬）', role: 'sales' },
  { id: 'demo-manager', name: '主管（模擬）', role: 'manager' },
  { id: 'demo-customer', name: '客戶（模擬）', role: 'customer' },
]
