...
export type CustomerEntity = 'customers' | 'contacts'

// Preview fixtures only. Replace with API data when the backend is ready.
export const customers: Customer[] = [
  { id: 'c1', name: '青禾設計', industry: '設計服務', owner: '林雅婷', createdAt: '2026-09-20', address: '台北市大安區信義路三段 88 號' },
  { id: 'c2', name: '遠山科技', industry: '資訊科技', owner: '陳柏宇', createdAt: '2026-09-19', address: '新竹市東區光復路一段 120 號' },
  { id: 'c3', name: '日光生活', industry: '零售電商', owner: '林雅婷', createdAt: '2026-09-18', address: '台中市西區公益路 66 號' },
  { id: 'c4', name: '森嶼品牌', industry: '品牌顧問', owner: '王怡安', createdAt: '2026-09-17', address: '台北市松山區民生東路四段 25 號' },
  { id: 'c5', name: '方舟物流', industry: '物流運輸', owner: '陳柏宇', createdAt: '2026-09-16', address: '桃園市桃園區中正路 300 號' },
]

export const contacts: Contact[] = [
  { id: 'p1', customerId: 'c1', name: '許子晴', title: '專案經理', email: 'zoe@example.com', phone: '02-5550-0101', createdAt: '2026-09-20' },
  { id: 'p2', customerId: 'c2', name: '張家豪', title: '技術總監', email: 'leo@example.com', phone: '03-555-0102', createdAt: '2026-09-19' },
  { id: 'p3', customerId: 'c3', name: '黃詩涵', title: '採購經理', email: 'mia@example.com', phone: '04-5550-0103', createdAt: '2026-09-18' },
  { id: 'p4', customerId: 'c4', name: '李承恩', title: '品牌企劃', email: 'ian@example.com', phone: '02-5550-0104', createdAt: '2026-09-17' },
  { id: 'p5', customerId: 'c5', name: '周品妤', title: '營運主管', email: 'amy@example.com', phone: '03-555-0105', createdAt: '2026-09-16' },
]
...
const locations = ['台北市大安區信義路', '新竹市東區光復路', '台中市西區公益路', '桃園市桃園區中正路', '高雄市苓雅區四維路', '台南市東區東門路']
const surnames = ['林', '陳', '王', '李', '張', '黃', '吳', '劉', '蔡', '楊']
const givenNames = ['子晴', '家豪', '詩涵', '承恩', '品妤', '宇軒', '雅筑', '柏翰', '佳穎', '冠廷', '怡君', '書瑋', '思妍', '彥廷', '欣儀']
