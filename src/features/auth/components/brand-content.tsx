...
export function BrandContent() {
  return (
    <section
      className="relative flex flex-col overflow-hidden bg-[#ecf2ed] px-6 py-6 min-[761px]:min-h-svh min-[761px]:px-8 min-[761px]:pt-8 min-[1001px]:px-[52px] min-[1001px]:pt-[42px] min-[1500px]:px-[70px]"
      aria-label="Connect CRM 介紹"
    >
      <a
        className="flex w-fit items-center gap-2.5 rounded-md text-2xl font-semibold tracking-tight text-[#183f32] focus-visible:outline-2 focus-visible:outline-offset-4 min-[761px]:text-[27px]"
        href="/"
      ...
      >
        ...
        Connect
        <span className="ml-px rounded border border-[#bccbc0] px-1.5 py-0.5 text-[10px] tracking-wider">CRM</span>
      </a>
      <div className="w-full pt-6 pb-2 min-[761px]:m-auto min-[761px]:max-w-[510px] min-[761px]:pt-16 min-[761px]:pb-11 min-[1500px]:max-w-[550px]">
        ...
        <div
          className="relative mt-5 mb-1 hidden h-[260px] place-items-center min-[761px]:grid min-[1500px]:mt-10 min-[1500px]:mb-6"
          aria-label="客戶關係管理示意"
        >
